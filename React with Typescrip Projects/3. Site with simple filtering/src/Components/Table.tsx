            ...
            <tr className="border border-gray-700">
              ...
              <td className="px-4 py-2">
                <div className="w-24 h-2 bg-gray-700 rounded">
                  <div
                    className={`w-[${project.progress}] h-2 w-24 bg-green-500 rounded`}
                  ></div>
                </div>
              </td>
              ...
              <td className="px-4 py-2">
                <div className="relative">
                  ...
                  {statusDropDownVisible === index && (
                    <div className="absoute top-full right-0 mt-2 bg-gray-800 border border-gray-700 rounded shadow-lg">
                      <button
